        ...
        <main className="flex-1 bg-background">
                ...
                <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
                        <div className="flex flex-col gap-6 rounded-[2.5rem] bg-background p-10 ring-1 ring-border/50">
                            ...
                            <h2 className="text-3xl font-bold tracking-tight text-foreground">Direct Pricing.</h2>
                        ...
                        <div className="flex flex-col gap-6 rounded-[2.5rem] bg-background p-10 ring-1 ring-border/50">
                            ...
                            <h2 className="text-3xl font-bold tracking-tight text-foreground">Low Margins.</h2>
                            <p className="text-lg font-medium tracking-tight text-muted-foreground">
                        ...
                        <div className="flex flex-col gap-6 rounded-[2.5rem] bg-background p-10 ring-1 ring-border/50">
                            ...
                            <h2 className="text-3xl font-bold tracking-tight text-foreground">Always Free.</h2>
                            <p className="text-lg font-medium tracking-tight text-muted-foreground">
            ...
            <section className="bg-rose-500 py-24 sm:py-32 lg:py-48 text-white">
                <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-12 text-xl font-medium tracking-tight sm:text-2xl opacity-90 leading-relaxed">
